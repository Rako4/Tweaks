...
echo.       
echo.                                    
echo                                   %ESC%[31m__________.__         ___________                       
echo                                   %ESC%I\______   \__I_____   \_   _____/______   ____   ____  
echo                                   %ESC%I I       _/  \____ \   I    __) \_  __ \_/ __ \_/ __ \ 
echo                                   %ESC%I I    I   \  I  I_) )  I     \   I  I \/\  ___/\  ___/ 
echo                                   %ESC%I I____I_  /__I   __/   \___  /   I__I    \___ ) \___ )
echo                                   %ESC%I        \/   I__I          \/                \/     \/ 
echo. 
echo.                                              %ESC%[31m© RIP Tweaks 2025 / Free V7.0
echo.
echo.
echo                                       %ESC%[90m %ESC%[31mYou're%ESC%[90m Using The %ESC%[31mFREE%ESC%[90m Version of %ESC%[31mRIP Tweaks%ESC%[90m.
echo                                 %ESC%[90m %ESC%[31mUnlock%ESC%[90m Your %ESC%[31mFULL%ESC%[90m PC Potential With RIP Tweaks %ESC%[31mPaid Packs%ESC%[90m!
echo                                      %ESC%[90m %ESC%[31mGain%ESC%[90m Up To %ESC%[31m10x More%ESC%[90m Performance at %ESC%[31mriptweaks.com%ESC%[90m
echo.
echo.
echo                           %ESC%[31m[%ESC%[37m 1 %ESC%[31m]%ESC%[37m 2GB RAM      %ESC%[31m[%ESC%[37m 2 %ESC%[31m]%ESC%[37m 4GB RAM      %ESC%[31m[%ESC%[37m 3 %ESC%[31m]%ESC%[37m 8GB RAM      %ESC%[31m[%ESC%[37m 4 %ESC%[31m]%ESC%[37m 12GB RAM
echo.                          %ESC%[90mRegistry Tweaks    %ESC%[90mRegistry Tweaks    %ESC%[90mRegistry Tweaks    %ESC%[90mRegistry Tweaks
echo.                          %ESC%[90mFor 2GB Of RAM     %ESC%[90mFor 4GB Of RAM     %ESC%[90mFor 8GB Of RAM     %ESC%[90mFor 12GB Of RAM  
echo.    
echo                           %ESC%[31m[%ESC%[37m 5 %ESC%[31m]%ESC%[37m 16GB RAM     %ESC%[31m[%ESC%[37m 6 %ESC%[31m]%ESC%[37m 24GB RAM     %ESC%[31m[%ESC%[37m 7 %ESC%[31m]%ESC%[37m 32GB RAM     %ESC%[31m[%ESC%[37m 8 %ESC%[31m]%ESC%[37m 64GB RAM
echo.                          %ESC%[90mRegistry Tweaks    %ESC%[90mRegistry Tweaks    %ESC%[90mRegistry Tweaks    %ESC%[90mRegistry Tweaks
echo.                          %ESC%[90mFor 16GB Of RAM    %ESC%[90mFor 24GB Of RAM    %ESC%[90mFor 32GB Of RAM    %ESC%[90mFor 64GB Of RAM  
echo.
echo.
echo.                                                 %ESC%[31m[%ESC%[37m 9 %ESC%[31m]%ESC%[31m Go Back (Main Menu)   
echo.     
echo.
set /p input= 
...
if /i %input% == 6 goto 24gb
if /i %input% == 7 goto 32gb
if /i %input% == 8 goto 64gb
if /i %input% == 9 goto main

echo "%input%" isn't a right choice, try again!
goto ram

:2gb
reg add "HKLM\SYSTEM\ControlSet001\Control" /v "SvcHostSplitThresholdInKB" /t REG_DWORD /d 0x200000 /f
goto ram

:4gb
reg add "HKLM\SYSTEM\ControlSet001\Control" /v "SvcHostSplitThresholdInKB" /t REG_DWORD /d 0x400000 /f
goto ram

:8gb
reg add "HKLM\SYSTEM\ControlSet001\Control" /v "SvcHostSplitThresholdInKB" /t REG_DWORD /d 0x800000 /f
goto ram

:12gb
reg add "HKLM\SYSTEM\ControlSet001\Control" /v "SvcHostSplitThresholdInKB" /t REG_DWORD /d 0xC00000 /f
goto ram

:16gb
reg add "HKLM\SYSTEM\ControlSet001\Control" /v "SvcHostSplitThresholdInKB" /t REG_DWORD /d 0x1000000 /f
goto ram

:24gb
reg add "HKLM\SYSTEM\ControlSet001\Control" /v "SvcHostSplitThresholdInKB" /t REG_DWORD /d 0x1800000 /f
goto ram

:32gb
reg add "HKLM\SYSTEM\ControlSet001\Control" /v "SvcHostSplitThresholdInKB" /t REG_DWORD /d 0x2000000 /f
goto ram

:64gb
reg add "HKLM\SYSTEM\ControlSet001\Control" /v "SvcHostSplitThresholdInKB" /t REG_DWORD /d 0x4000000 /f
goto ram
...
echo.
echo.
echo                                        %ESC%[31m[%ESC%[37m 1 %ESC%[31m]%ESC%[37m Windows 10           %ESC%[31m[%ESC%[37m 2 %ESC%[31m]%ESC%[37m Windows 11
echo.                                       %ESC%[90mOptimize Your Windows      %ESC%[90mOptimize Your Windows
echo.                                       %ESC%[90m10 For Performance         %ESC%[90m11 For Performance  
echo.     
echo.                                                   %ESC%[31m[%ESC%[37m 3 %ESC%[31m]%ESC%[37m Services
echo.                                                   %ESC%[90mDisable Useless Services
echo.                                                   %ESC%[90mTo Increase Performance
echo.
echo.
echo.                                                 %ESC%[31m[%ESC%[37m 4 %ESC%[31m]%ESC%[31m Go Back (Main Menu)   
echo.     
echo.
set /p input= 
if /i %input% == 1 goto windows10
if /i %input% == 2 goto windows11
if /i %input% == 3 goto services
...
echo.
echo.
echo                                         %ESC%[31m[%ESC%[37m 1 %ESC%[31m]%ESC%[37m DEBLOAT             %ESC%[31m[%ESC%[37m 2 %ESC%[31m]%ESC%[37m REVERT
echo.                                        %ESC%[90mSafe Debloat For Both     %ESC%[90mRevert For All Of
echo.                                        %ESC%[90mWindows 10 and 11         %ESC%[90mThe Debloat Tweaks
echo.     
echo.
echo.
echo.
echo.                                                 %ESC%[31m[%ESC%[37m 3 %ESC%[31m]%ESC%[31m Go Back (Main Menu)   
echo.     
echo.
set /p input= 
if /i %input% == 1 goto debloat
if /i %input% == 2 goto debloatrevert
...
sc config BthAvctpSvc start=manual
...
echo.
echo.
echo                                   %ESC%[31m[%ESC%[37m 1 %ESC%[31m]%ESC%[37m Remove Input-Delay            %ESC%[31m[%ESC%[37m 2 %ESC%[31m]%ESC%[37m USB Tweaks
echo.                                  %ESC%[90mRemove Input Delay With The Help    %ESC%[90mOptimize USB Ports       
echo.                                  %ESC%[90mOf Various Scripts and Registries   %ESC%[90mFor The Least Input Lag
echo. 
echo                                    %ESC%[31m[%ESC%[37m 3 %ESC%[31m]%ESC%[37m Optimize Keyboard       %ESC%[31m[%ESC%[37m 4 %ESC%[31m]%ESC%[37m Optimize Mouse
...
echo.
echo.
echo.                                                 %ESC%[31m[%ESC%[37m 5 %ESC%[31m]%ESC%[31m Go Back (Main Menu)   
echo.     
echo.
set /p input= 
if /i %input% == 1 goto realinputdelay
if /i %input% == 2 goto usbtweaks
if /i %input% == 3 goto keyboard
if /i %input% == 4 goto mouse
...
echo.
set /p input= 
if /i %input% == 1 goto lowerping
if /i %input% == 2 goto internet
if /i %input% == 3 goto main
